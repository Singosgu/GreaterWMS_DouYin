...
class MaterialGet_cap_infoy(viewsets.ModelViewSet):
    """
        create:
            支持获取店铺数据
            获取商家容量详情
            1. 返回的容量单位都是B，如果想转成G，请除以 1024*1024；
            2. 目前权益类型（equity_type）有：Free-免费容量，B-B类商家独有权益，JBP-JBP类商家独有权益 这三类，后续会慢慢增加。
    """
