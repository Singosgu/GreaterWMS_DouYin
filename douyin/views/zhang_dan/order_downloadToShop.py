...
class OrderDownloadToShop(viewsets.ModelViewSet):
    """
        create:
            支持获取店铺数据
            查看是否下载成功并返回下载链接(境内)
            查询该下载文件是否已经生成并返回下载链接
            download_id从/order/downloadSettleItemToShop接口获取
            状态码,链接时效为1小时，失效后需重新调此接口获取新的链接
            100000-成功
    """
