...
class OrderDownloadShopAccountItem(viewsets.ModelViewSet):
    """
        create:
            支持获取店铺数据
            资金流水明细下载请求(境内)
            请求下载资金流水明细，得到download_id,download_id获取文件需要从order/downloadShopAccountItemFile接口获取，数据T+1生成，建议第二天10点之后下载
    """
    ...
    def create(self, request, *args, **kwargs):
        path = '/order/downloadShopAccountItem'
        params = self.params
