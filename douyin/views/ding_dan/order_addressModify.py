...
class OrderAddressModify(viewsets.ModelViewSet):
    """
        create:
            支持获取店铺数据
            用于卖家和买家沟通后，主动帮买家修改收货信息
            支持单独修改收货地址、收货人信息和收货人电话号码，如果修改收货地址，那么post_addr的province、town 、city、address_detail都必传。
    """
